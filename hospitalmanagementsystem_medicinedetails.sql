...
LOCK TABLES `medicinedetails` WRITE;
/*!40000 ALTER TABLE `medicinedetails` DISABLE KEYS */;
INSERT INTO `medicinedetails` VALUES ('a','d','b','b','b','b','b','b'),('b','d','b','b','b','b','b','b');
/*!40000 ALTER TABLE `medicinedetails` ENABLE KEYS */;
UNLOCK TABLES;
